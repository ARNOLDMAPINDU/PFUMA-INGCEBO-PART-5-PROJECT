...
PFUMA/INGCEBO is not just a farm-management app — it is a digital layer over the real, legally-defined process Zimbabwe already uses to keep livestock trade honest and disease under control: ownership proof, veterinary inspection, and police clearance before a sale. PFUMA/INGCEBO digitizes that process end-to-end across six stakeholders — **Farmer, Veterinarian, Supplier, Buyer, Police, and Institutions (banks/insurers)** — instead of leaving it to paper records, word-of-mouth, and informal trust.
...
Outbreaks aren't just diagnosed one animal at a time: a Farmer or Vet can formally **report a suspected outbreak**, a Vet or Admin **verifies** it, and verification automatically **broadcasts an alert to farmers in the affected area** — a real, timestamped, region-scoped early-warning pipeline, not an informal word-of-mouth warning.
...
This is no longer just a claim: the **Institution role** lets a bank or insurer look up a vet-issued valuation certificate directly — verified identity, health history, estimated market value — and flag it in their own ledger for a loan or policy. It is the concrete mechanism behind "livestock wealth becomes usable collateral," not an aspiration.

### 1.3a Collective action through cooperatives
Farmers can form or join a **cooperative** to coordinate a shared dip-tank schedule and raise group veterinary requests, rather than every household acting alone. This mirrors how communal and A1 farmers already organize informally, and gives that informal structure a real record vets and DVS can see.
...
| Buyer signup requires acknowledging Consumer Protection Act obligations; no blanket "no refund" listings permitted | **Consumer Protection Act [Chapter 14:44]** — mandatory disclosure in plain language, a visible fixed price, and a statutory right to return defective goods within 6 months | [consumer-protection-retailers.md](compliance/laws/consumer-protection-retailers.md) |
